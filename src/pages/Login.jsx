...
const Login = () => {
  ...
  return (
    <motion.main 
      ...
      animate={{ opacity: 1 }}
      exit={{ opacity: 0 }}
      className="min-h-screen flex items-center justify-center pt-20 px-6 bg-accent-cream dark:bg-dark-bg"
    >
      <div className="w-full max-w-md bg-white dark:bg-dark-surface p-10 rounded-3xl shadow-2xl border border-gray-100 dark:border-white/5">
        <div className="text-center mb-8">
          <h1 className="text-3xl font-display font-extrabold text-gradient mb-2">Welcome Back</h1>
          <p className="text-gray-500 dark:text-gray-400 text-sm">Enter your credentials to access your AI Stylist</p>
        </div>
